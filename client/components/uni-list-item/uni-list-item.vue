	...
	<view :class="disabled ? 'uni-list-item--disabled' : ''" :hover-class="disabled || showSwitch ? '' : 'uni-list-item--hover'"
	 class="uni-list-item" @click="onClick">
		<view class="uni-list-item__container" :class="[{'border': border0}, size]">
			<view v-if="thumb" class="uni-list-item__icon" :class="size">
				<image :src="thumb" class="uni-list-item__icon-img" :class="size" mode="widthFix"/>
			</view>
			...
			<view v-if="showBadge || showArrow || showSwitch" class="uni-list-item__extra">
				...
				<switch v-if="showSwitch" :disabled="disabled" color="#ff2b1f" :checked="switchChecked" @change="onSwitchChange" />
